...
class HomeView: UITextView {
  ...
  */
  ...
  func createText() {
    ...
    descrip = "Change your mood instantly." + "\n\n"
    descrip += "If you‘re feeling sad, grumpy, depressed or down right angry, then grab a Bliss Bom." + "\n\n"
    descrip += "If the world around you is making you feel like there’s something wrong with you, or circumstances and events are making you feel like you’re missing out, or you’re just not getting this reality or not fitting in, then grab a Bliss Bom." + "\n\n"
    //descrip += "grab a Bliss Bom!" + "\n\n"
    ...
    descrip += "Simply read your way into a better mood and watch your life change for the better!" + "\n\n"
    ...
    caption = "Bliss Boms is a creation of Back To Bliss; a business created to invite you back to bliss."
